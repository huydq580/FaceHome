...
class CreateGroupCuDan extends Component {
    ...
    AddMember = () => {
        ...
        fetch(URL_SOCKET + MsgGroupID, {
            ...
            this.props.navigation.navigate("ChatGroupCuDan", { title : this.state.TenGroup, MsgGroupID: dataRes.ObjectResult[0].MsgGroupID
            })
        }).catch(e => {
...
CreateGroupCuDan = connect(mapStateToProps, mapDispatchToProps)(CreateGroupCuDan);
export default CreateGroupCuDan;
