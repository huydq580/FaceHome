...
class SoanTin extends Component {
    ...
    share() {
        ...
        callApiCreatePost(InfoUser[0].KDTID,InfoUser[0].UserID,InfoUser[0].ProfileID, InfoUser[0].Type, InfoUser[0].FullName, this.state.Status, this.state.linkImg, InfoUser[0].Avatar).then(dataPost => {
