                ...
                <FlatList
                    ...
                    renderItem = {({item}) =>
                        <TouchableOpacity onPress = {()=>{
                            ...
                            callApiMsgGroupID(UserBQL.payload[0].KDTID,UserBQL.payload[0].UserID, UserBQL.payload[0].FullName,UserBQL.payload[0].IntUserID, item.UserID,  item.FullName,item.IntUserID, UserBQL.payload[0].UserID, UserBQL.payload[0].FullName).then(dataRes=> {
